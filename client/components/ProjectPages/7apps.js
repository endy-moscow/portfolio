  ...
  return (
    <div className='canvas'>
      <Header
        ...
        imgUrl='http://postpeople.ru/media/7apps/cover.jpg'
        />
      <article className='7apps'>
        <div className='content_container'>
          <section className='block'>
            <p>В начале 2016 года, я получил заказ на разработку сайта студии. В данный момент сайт студии уже не поддерживается, но в BitBacket сохранилась его копия. Я не стал копировать сайт полностью, в нем не было ничего особенного, кроме баннеров.</p>
        ...
        <div className='content_container'>
          <section className='block'>
            ...
            <p className='quote'>Откройте мир ярких и увлекательных овощных приключений Литл Шефа! Отправляйтесь вместе с ним на встречу вкусным приключениям и ароматным победам. Помогите поваренку достичь вершин кулинарного мастерства и преодолеть множество препятствий на своем пути.</p>
          </section>
        </div>
        ...
        <section className='block'>
        <div className='content_container'>
            <h1>Cosmic <span className='grey'>(Рабочее название)</span></h1>
            <p>К сожалению, эта игра про битву роботов против инопланетян так и не вышла.</p>
        </div>
        </section>
